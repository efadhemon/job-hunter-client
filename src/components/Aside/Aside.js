...
import { faUser, faBriefcase, faAddressCard, faList, faHeart, faHome } from '@fortawesome/free-solid-svg-icons';
        ...
        <div className="aside">
            ...
            <div className="aside-inner">
                ...
                <ul id="nav" className="my-nav">
                    ...
                    <li onClick={handleSidebar}><Link to="/jobs" className={mainPath === 'jobs' ? 'active' : undefined}><FontAwesomeIcon icon={faBriefcase} /> Jobs</Link></li>
